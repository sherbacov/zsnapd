...
settings['regex_dataset_default'] = r'[-_:./a-zA-Z0-9]+'
settings['regex_dataset'] = settings['regex_dataset_default']
settings['regex_dataset_server_format'] = r'\b[-_:.a-zA-Z0-9]+/[-_:.a-zA-Z0-9]*{0}[-_:.a-zA-Z0-9]*'
